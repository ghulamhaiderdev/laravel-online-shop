...
{{--                                    <b>Invoice #{{ $order->id }}</b><br>--}}
                ...
                <div class="col-md-3">
                    <div class="card">
                        <form action="" method="post" name="chaneOrderStatus" id="chaneOrderStatus">
                            @csrf
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ $order->shipped_date }}" type="text" name="shipped_date" id="shipped_date" placeholder="Shipped Date" class="form-control">
                            </div>
                            <div class="mb-3">
...
@section('customJs')
    <script>
        ...
        $('#chaneOrderStatus').submit(function (event){
